  ...
  return (
    <main className="container flex flex-col gap-8">
      ...
      <p>
        ...
        hesitate to contact us. Our Privacy Policy was
      ...
      <p>
        ...
        Privacy Policy depends on the Personal Information
      ...
      <ul>
        ...
        <li>
          You have given Nuno Carro Developer permission to
          do so
        </li>
        <li>
          Processing your personal information is in Nuno
          Carro Developer legitimate interests
        </li>
        <li>
      ...
      <p>
        ...
        purposes set out in this Privacy Policy. We will
        retain and use your information to the extent
      ...
      <p>
        ...
        for each of the advertising partners of Nuno Carro
        Developer.
      </p>
      ...
      <p>
        ...
        advertisements and links that appear on Nuno Carro
        Developer, which are sent directly to users'
      ...
      <p>
        Note that Nuno Carro Developer has no access to or
      ...
      <p>
        Nuno Carro Developer does not knowingly collect any
      ...
      <p>
        ...
        and/or collect in Nuno Carro Developer. This policy
