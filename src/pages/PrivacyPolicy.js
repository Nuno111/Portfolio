  ...
  return (
    <main className="container flex flex-col gap-8">
      ...
      <p>
        ...
        Nuno Carro Developer and how we use it.
      </p>
      <p>
      ...
      <ul className="px-10 list-disc">
        <li>Nuno Carro Developer needs to perform a contract with you</li>
        <li>You have given Nuno Carro Developer permission to do so</li>
        <li>
          Processing your personal information is in Nuno Carro Developer
          legitimate interests
        </li>
        <li>Nuno Carro Developer needs to comply with the law</li>
      </ul>
      <p>
        Nuno Carro Developer will retain your personal information only for as
      ...
      <p>
        ...
        advertising partners of Nuno Carro Developer.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Nuno Carro Developer, which are
      ...
      <p>
        Note that Nuno Carro Developer has no access to or control over these
      ...
      <p>
        Nuno Carro Developer does not knowingly collect any Personal
      ...
      <p>
        ...
        shared and/or collect in Nuno Carro Developer. This policy is not
