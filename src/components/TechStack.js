...
const TechStack = () => {
	return (
		<section className="container">
			<h3 className="text-2lx py-12 text-center text-2xl font-bold sm:text-3xl md:text-4xl lg:py-28">
				Tech Stack
			</h3>
			<ul className="grid gap-10 grid-cols-3 text-sm sm:grid-cols-5 xl:grid-cols-10">
